			...
			<div class="large-6 columns">
                ...
                <div class="divider"><span></span></div>
					...
					<div class="contact_form">
						<div class="row">
							<form method="POST" action="Contact_entry" class="contactForm" name="contactform">
								<div class="small-4 columns">
									<input type="text" placeholder="Name" id="cname" name="cname"/>
								</div>
								<div class="small-4 columns">
									<input type="email" placeholder="E-mail" id="cemail" name="cemail"/>
								</div>
								<div class="small-4 columns">
									<input type="text" placeholder="Mob No" id="cmob" name="cmob"/>
								</div>
								<div class="small-12 columns">
									<textarea cols="10" rows="15" placeholder="Message" id="cmessage" name="cmessage"></textarea>
								</div>
								<div class="small-4 columns">
						...
						<% if(request.getAttribute("success")!=null){
							%><div class="row">
								<div class="large-12 column red">
									<p class="text-center">Your query has been submitted successfully. We will reply you soon.</p>
								</div>
							</div><%
						} %>
					</div>
				...
				<div class="large-4 columns">
							<h2>India Helpline</h2>
                            <h4>For Patients</h4>
                            <dl>
                                <dt>Appointment Booking/Cancellation</dt>
                                <dd>+91 9782764132</dd>
                            </dl>
                            <h4>For Doctors</h4>
                            <dl>
                                <dt>Profile listing on meetmydoctor.com</dt>
                                <dd>+91 9460412681</dd>
                                <dt>MeetMyDoctor Customer Support</dt>
                                <dd>+91 9782764132</dd>
                            </dl>
                            <h4>Corporate</h4>
                            <dl>
                                <dt>Hiring and other queries</dt>
                                <dd>+91 9876543210</dd>
                            </dl>
				</div>	
			</div><!-- End Row -->
