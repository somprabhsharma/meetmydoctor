...
<div class="main-wrapper">
	...
	Object obj = request.getParameter("page");
						...
						ResultSet rs = stmt.executeQuery("select * from admin where admin_id = '"+userid+"'");
						String name=null;
						if(rs.next()){
							name = rs.getString(2);
						}
...
<div class="main-wrapper">
	<div class="row main-content"><!-- Main Content -->
    	<div class="large-12 columns">
			...
			%><jsp:include page="component/admin/content.jsp"/><%
			} %>
			<% if(obj.toString().equals("gen_report")){
			%><jsp:include page="component/admin/gen_report.jsp"/><%
			} %>
			<% if(obj.toString().equals("block")){
			%><jsp:include page="component/admin/block.jsp"/><%
			} %>
			<% if(obj.toString().equals("add_admin")){
			%><jsp:include page="component/admin/add_admin.jsp"/>
			    <div class="row">
   				<div class="large-3 columns"><p>&nbsp;</p></div>
    			<div class="large-6 columns"><div class="success_box"></div>
    			<div class="error_box"></div></div></div>
			<%
			} %>
...
new FormValidator('adminform', [{
    ...
    rules: 'required|matches[apassword]'
}, {
    name: 'aemail',
    display: 'Email',
